...
def vedantu(user):
    ...
    try:
        def vedantu_login():
            ...
            sign_in_button = driver.find_element_by_xpath('//*[@id="login-link"]')
            driver.execute_script("arguments[0].click();", sign_in_button)
            
            email_box = driver.find_element_by_xpath('//*[@id="login-email-phone"]/input')
            email_box.send_keys("sharadmamtaald@gmail.com")
            
            next_button = driver.find_element_by_xpath('//*[@id="login-submit3"]')
            next_button.click()
            
            driver.implicitly_wait(5)
            
            password_box = driver.find_element_by_xpath('//*[@id="password-input-field"]')
            password_box.send_keys("#Shreeji@IITH24")
            
            driver.implicitly_wait(6)
            
            next_button_2 = driver.find_element_by_xpath('//*[@id="login-submit2"]')
...
# if 'vedantu' or 'sessions' or 'session' in q:
#     vedantu(q)
